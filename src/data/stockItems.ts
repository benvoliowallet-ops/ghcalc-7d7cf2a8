...
export const STOCK_ITEMS: StockItem[] = [
  ...
  { code: 'MAXTRA_300_STANDARD', name: 'MAXIVAREM LS 300 V PN10 6/4" tlakova nadoba ŠTANDARD', additionalText: '', price: 305.02, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
  { code: 'MAXTRA_300_SS', name: 'MAXIVAREM LS 300 V PN10 SS variant', additionalText: '', price: 380.0, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
  { code: 'MAXTRA_500_STANDARD', name: 'MAXIVAREM ŠTANDARD (500L)', additionalText: '', price: 500.0, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
  { code: 'MAXTRA_500_SS', name: 'MAXIVAREM SS (500L)', additionalText: '', price: 600.0, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
  { code: 'MAXTRA_750_STANDARD', name: 'MAXIVAREM ŠTANDARD (750L)', additionalText: '', price: 700.0, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
  { code: 'MAXTRA_750_SS', name: 'MAXIVAREM SS (750L)', additionalText: '', price: 850.0, group: 'Tlaková nádoba', supplier: 'MAXTRA CONTROL' },
